...
- 💻 **Focus Areas:** Full-Stack Web Development & Embedded/Edge AI Systems
- 🤖 **Research Interests:** Computer Vision, Medical Imaging, and Applied Machine Learning
- 📄 **Publications:** Co-authored a conference research paper on AI applications
- 🚀 **Goal:** Building scalable software solutions and edge-computing applications
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=c,cpp,cs,dotnet,py,js,html,css,react,nextjs,php,kotlin,mysql,postgres,oracle,git,github,vscode,postman,figma" alt="Skill Icons" height="80" />
</p>
...
- 👁️ **Computer Vision & Image Processing** (Medical Image Analysis, Object Detection)
- 🌾 **Smart Agriculture** (AI-based Crop Disease Detection & Field Monitoring)
- 📊 **Predictive Modeling** (Classification models, Time-Series Data, Edge ML)
- 🗣️ **Natural Language Processing & AI Agents**
...
<p align="center">
  ⭐️ <i>Thanks for stopping by! Feel free to explore my repositories or reach out for collaboration.</i>
</p>
